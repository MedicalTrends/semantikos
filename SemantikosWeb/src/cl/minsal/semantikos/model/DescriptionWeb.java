...
public class DescriptionWeb extends Description {
    ...
    public boolean equals(Object o) {
        ...
        System.out.println("this.getTerm().equals(descriptionWeb.getTerm())="+this.getTerm().equals(descriptionWeb.getTerm()));
        System.out.println("this.isCaseSensitive()==descriptionWeb.isCaseSensitive()="+(this.isCaseSensitive()==descriptionWeb.isCaseSensitive()));
        System.out.println("this.isAutogeneratedName()==descriptionWeb.isAutogeneratedName()="+(this.isAutogeneratedName()==descriptionWeb.isAutogeneratedName()));
        System.out.println("this.getDescriptionType().equals(descriptionWeb.getDescriptionType()="+this.getDescriptionType().equals(descriptionWeb.getDescriptionType()));
