    ...
    public ConceptSMTKWeb(ConceptSMTK conceptSMTK) {
        ...
        if(conceptSMTK.isPersistent()){
            ...
            for (Description description : this.getDescriptions()) {
                ...
                this.descriptionsBackup.add(new Description(description.getId(), description.getDescriptionId(), description.getDescriptionType(), description.getTerm(), description.isCaseSensitive(),
                                                            description.isAutogeneratedName(), description.isActive(), description.isPublished(), description.getValidityUntil()));
            }
