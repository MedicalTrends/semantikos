...
import static cl.minsal.semantikos.model.helpertables.ConditionalOperator.GREATER_OR_GREATER_THAN;
...
public class HelperTableWhereConditionTest {
    ...
    public void testToString() throws Exception {
        ...
        HelperTableWhereCondition<Timestamp> validityUntilCondition = new HelperTableWhereCondition<>(SYSTEM_COLUMN_VALIDITY_UNTIL, GREATER_OR_GREATER_THAN, now);
