...
public class Description extends PersistentEntity implements AuditableEntity {
     ...
     */
    public Description(long id, ConceptSMTK conceptSMTK, String descriptionID, DescriptionType descriptionType, String term, boolean isCaseSensitive, boolean isAutoGenerated, boolean isPublished, Timestamp validityUntil, Timestamp creationDate, User creatorUser) {
        super(id);
     ...
     * @param validityUntil   Fecha tope de vigencia.
     */
    public Description(ConceptSMTK conceptSMTK, String descriptionID, DescriptionType descriptionType, String term, boolean isCaseSensitive, boolean isAutoGenerated, boolean isPublished, Timestamp validityUntil, Timestamp creationDate, User creatorUser) {
        this(DAO.NON_PERSISTED_ID, conceptSMTK, descriptionID, descriptionType, term, isCaseSensitive, isAutoGenerated, isPublished, validityUntil, creationDate, creatorUser);
    }
    ...
    public Description(ConceptSMTK conceptSMTK, String term, DescriptionType descriptionType) {
        this(-1, conceptSMTK, "NULL", descriptionType, term, false, false, false, null, new Timestamp(currentTimeMillis()), User.getDummyUser());
    }
