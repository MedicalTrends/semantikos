 ...
 */
@Stateless(name = "JbossSecurutyDomainAuthenticationEJB")
public class JbossSecurutyDomainAuthenticationBean extends AuthenticationMethod{

    static private final Logger logger = LoggerFactory.getLogger(JbossSecurutyDomainAuthenticationBean.class);
